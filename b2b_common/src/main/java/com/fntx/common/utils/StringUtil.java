...
public class StringUtil {
	...
	public static boolean empty(String param) {
		return param == null || param.trim().length() < 1 || param == "";
	}
	 ...
	 * @return
	 */
	public static String toUpperCaseFirstOne(String aa){
		if (Character.isUpperCase(aa.charAt(0))) {
			return aa;
		}else{
			return (new StringBuilder()).append(Character.toUpperCase(aa.charAt(0))).append(aa.substring(1)).toString();
		}
	}
	/**
	 * 将字符串首字母转小写
