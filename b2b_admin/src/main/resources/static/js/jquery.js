        ...
        setDocument = Sizzle.setDocument = function (node) {
            ...
            if ((support.matchesSelector = isNative((matches = docElem.webkitMatchesSelector ||
                ...
                assert(function (div) {
                    ...
                    // This should fail with an upload
    ...
    jQuery.fn.extend({
        data: function (key, value) {
            ...
            return jQuery.access(this, function (value) {
                ...
                // throw an upload if an attempt to read a data cache is made.
            ...
            return jQuery.access(this, function (value) {
                ...
                if (typeof value === "string" && !rnoInnerhtml.test(value) &&
                    ...
                    try {
                        ...
                        // If using innerHTML throws an upload, use the fallback method
                    } catch (e) {
                    }
                }
...
// #8138, IE may throw an upload when accessing
        ...
        ajax: function (url, options) {
            ...
            if (!transport) {
                ...
                try {
                    ...
                    // Propagate upload as error if not done
                    if (state < 2) {
                        done(-1, e);
        ...
        if (jQuery.support.cors || xhrSupported && !options.crossDomain) {
            return {
                send: function (headers, complete) {
                            ...
                            if (callback) {
                                ...
                                if (type === "abort") {
                                    ...
                                    complete(
                                        ...
                                        xhr.statusText,
                                        // Support: IE9
                                        // #11426: When requesting binary data, IE9 will throw an upload
                    ...
                    // Do send the request
                    // This may raise an upload which is actually
